...
| current_repo-specific | `current_repo-{component}` | `current_repo-api`, `current_repo-ui`, `current_repo-sdk-check` |
| Testing skill | `current_repo-test-{component}` | `current_repo-test-sdk`, `current_repo-test-api` |
...
## Decision: current_repo-Specific vs Generic

```
Patterns apply to ANY project?     → Generic skill (e.g., pytest, typescript)
Patterns are current_repo-specific?     → current_repo-{name} skill
Generic skill needs current_repo info?  → Add references/ pointing to current_repo docs
```
